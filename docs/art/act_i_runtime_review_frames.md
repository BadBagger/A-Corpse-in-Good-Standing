...
| R06 / The Bone Chandler | `docs/art/review/act_i_runtime_frames/bone_chandler_runtime_frame.png` | Corvin, HUD, 1 standee(s), 1 standee reflection(s); caption: The Bone Chandler smiles like a receipt with teeth. |
| R07 / The Almshouse | `docs/art/review/act_i_runtime_frames/almshouse_runtime_frame.png` | Corvin, HUD, 1 standee(s), 1 standee reflection(s); caption: Prosper forgets the debt. The kindness stays, annoyingly. |
| R09 / Church of the Drowned | `docs/art/review/act_i_runtime_frames/church_of_the_drowned_runtime_frame.png` | Corvin, HUD, 1 standee(s), 1 standee reflection(s); caption: Teodor sells paid truth with the expression of a man losing money on God. |
| R10 / The Grey Float | `docs/art/review/act_i_runtime_frames/grey_float_runtime_frame.png` | Corvin, HUD, 1 standee(s), 1 standee reflection(s), 1 overlay(s); caption: Juno: Everybody comes here to feel something. You are just honest about failing. |
| R12 / Sabine's Office | `docs/art/review/act_i_runtime_frames/sabine_office_runtime_frame.png` | Corvin, HUD, 1 standee(s), 1 standee reflection(s), 1 overlay(s); caption: Sabine checks for a pulse. Her hand stays there anyway. |
