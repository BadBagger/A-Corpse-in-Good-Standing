...
| R06 / The Bone Chandler | `docs/art/review/act_i_gameplay_review_panels/bone_chandler_gameplay_panel.png` | The Bone Chandler smiles like a receipt with teeth. |
| R07 / The Almshouse | `docs/art/review/act_i_gameplay_review_panels/almshouse_gameplay_panel.png` | Prosper forgets the debt. The kindness stays, annoyingly. |
| R09 / Church of the Drowned | `docs/art/review/act_i_gameplay_review_panels/church_of_the_drowned_gameplay_panel.png` | Teodor sells paid truth with the expression of a man losing money on God. |
| R10 / The Grey Float | `docs/art/review/act_i_gameplay_review_panels/grey_float_gameplay_panel.png` | Juno: Everybody comes here to feel something. You are just honest about failing. |
| R12 / Sabine's Office | `docs/art/review/act_i_gameplay_review_panels/sabine_office_gameplay_panel.png` | Sabine checks for a pulse. Her hand stays there anyway. |
