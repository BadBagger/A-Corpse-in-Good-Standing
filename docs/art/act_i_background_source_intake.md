...
Status: no_source_outputs_present. This is source-output intake, not final art acceptance.
...
Counts:
- Prompts: 130
- Present source outputs: 0
- Pending source outputs: 130
- Zero-byte outputs: 0
...
|---|---|---|---|---|---|
| mudflats_generated_reference_cold_horizon_wash | generated_reference | imagegen | pending_source | `docs/art/reference/act_i/mudflats/cold_horizon_wash.png` | `-` |
| mudflats_generated_reference_dawn_haze | generated_reference | imagegen | pending_source | `docs/art/reference/act_i/mudflats/dawn_haze.png` | `-` |
| mudflats_generated_reference_wet_silt_texture | generated_reference | imagegen | pending_source | `docs/art/reference/act_i/mudflats/wet_silt_texture.png` | `-` |
