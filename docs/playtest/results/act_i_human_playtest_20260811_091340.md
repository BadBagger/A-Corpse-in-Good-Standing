# Act I Human Greybox Playtest Notes

Created: 2026-08-11 09:13:40
Template: `docs/playtest/act_i_human_greybox_playtest.md`
...
Then run the playable Godot project normally and start from a clean save.
