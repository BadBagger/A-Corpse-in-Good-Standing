...
- Act I Godot runtime frames: pass, 9 runtime-composition player-view frames show actual room scene background paths, shared art constants, foreground props, wet-floor reflections, HUD textures, NPC standees, in-world hotspot glints, Corvin side sprites, Corvin's subtle amber readability rim, and standee character integration rims.
