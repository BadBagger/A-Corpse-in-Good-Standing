...
- Act I in-scene action review: pass, 9 room-composition frames show Corvin talk/use/wet actions in context, including the Salt Market crowd turn_to_corvin state, named NPC dialogue/counter staging, visible wet interaction pulses, and zoom crops for action readability.
