...
Generated at UTC: 2026-08-12T02:28:06.8600323Z
Source modified UTC: 2026-08-12T02:23:32.1970523Z
...
### 16. Inspect the hotspot overlay against each room composition.
...
### 17. Review the ready background source generation packets.
...
### 18. Use the paintover packet as the room-by-room final-art brief.
- Command: manual review
...
### 19. Complete the art readability checklist.
- Command: manual review
...
### 20. Export, validate, and fill the batch review decision sheet.
...
### 21. Dry-run the batch review decisions.
...
### 22. Apply the reviewed decision sheet after the dry run is clean.
...
### 23. Check the safe paintover source scaffolds.
...
### 24. Re-run the paintover start gate.
...
### 25. Generate the approved-room paintover work order.
...
### 26. Validate final PSD source intake against the work order.
...
### 27. Audit final paintover completion.
...
### 28. Audit paintover review provenance across all final-art handoff layers.
