...
def add_game_hud(image: Image.Image, room_code: str, title: str, caption: str) -> None:
    ...
    draw.text((32, 46), "LOOK  USE  TALK  WET", fill=PALETTE["amber"], font=font)
...
def main() -> None:
    ...
    report = {
        ...
        "runtime_evidence": "In-scene action review frames show Corvin talk/use/wet side actions inside Act I rooms, including the Salt Market crowd turn_to_corvin sectional setpiece state, named NPC standee dialogue/counter staging, generated game HUD, embedded HUD dialogue text, and text-free wet interaction effects.",
        "frames": records,
    }
