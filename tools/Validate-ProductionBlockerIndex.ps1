...
$requiredPhrases = @(
    ...
    "Adapt talk/use source motions and author wet as a custom brine action in the canonical Corvin blend, then render/import Act I side sheets before front/back or Act II-III decay sheets",
