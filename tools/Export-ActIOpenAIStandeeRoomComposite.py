...
ROOMS = [
    ("R02", "The Old Quay", "old_quay", "old_quay_blockout_bg.png", [("tomas_bollard", 400, 735)]),
    ("R03", "Salt Market", "salt_market", "salt_market_bg.png", [("market_crowd", 1010, 790)]),
    ("R05", "Harbor Registry", "harbor_registry", "harbor_registry_bg.png", [("registrar", 1230, 705)]),
    ("R06", "The Bone Chandler", "bone_chandler", "bone_chandler_bg.png", [("bone_chandler", 1200, 760)]),
    ("R07", "The Almshouse", "almshouse", "almshouse_bg.png", [("prosper", 1190, 775)]),
    ("R09", "Church of the Drowned", "church_of_the_drowned", "church_of_the_drowned_bg.png", [("teodor", 1230, 740)]),
    ("R10", "The Grey Float", "grey_float", "grey_float_bg.png", [("juno", 1250, 745)]),
    ("R12", "Sabine's Office", "sabine_office", "sabine_office_bg.png", [("sabine", 1260, 735)]),
]


def composite_room(room_id: str, title: str, folder: str, background: str, standees: list[tuple[str, int, int]]) -> Image.Image:
    ...
    for standee_id, foot_x, foot_y in standees:
