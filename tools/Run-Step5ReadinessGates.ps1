...
try {
    ...
    Invoke-Step -Name "Validate Act I background ready source packets" -ScriptName "Validate-ActIBackgroundReadySourcePackets.ps1" -TimeoutSeconds 120
    Invoke-Step -Name "Validate Act I Meshy queue" -ScriptName "Validate-ActIBackgroundMeshyQueue.ps1" -TimeoutSeconds 120
