...
foreach ($requiredText in @(
    ...
    "All six Blender entrypoints execute in audit mode without creating PNG sheets and report whether keyed talk/use/wet actions still need to be authored in the source blend.",
