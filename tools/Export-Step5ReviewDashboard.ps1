...
$workflow = @(
    ...
    [ordered]@{
        step = 16
        action = "Open Corvin's rendered side-action contact sheet."
        command = ""
        artifact = "docs/art/review/corvin_side_actions_contact_sheet.png"
        pass_condition = "Reviewer checks talk/use/wet side-left and side-right frames for scale jitter, wrong-facing snaps, and readable brine/drip intent before marking Corvin side-action contact sheet reviewed."
    },
    [ordered]@{
        step = 17
