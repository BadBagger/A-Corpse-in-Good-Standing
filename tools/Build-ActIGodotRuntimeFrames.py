...
def main() -> None:
    ...
    report = {
        ...
        "runtime_evidence": "Godot runtime-composed review frames using actual room scene background paths, shared runtime art constants, runtime foreground props, contact shadows, wet-floor reflections, standee wet-floor reflections, room-specific dialogue captions embedded in the in-frame HUD, atmosphere, HUD, NPC standees, and the actual Corvin character scene using RuntimeSprite loader.",
        "rooms": records,
    }
