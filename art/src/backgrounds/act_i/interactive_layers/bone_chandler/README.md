# The Bone Chandler - interactive_layer_sources
...
Expected files:
- `art/src/backgrounds/act_i/interactive_layers/bone_chandler/prosperwatch.psd` - interactive_layer, paintover, runtime: `game/rooms/bone_chandler/props/prosperwatch.png`, review: verify alpha, bounds, hotspot center alignment, and role readability in Godot
