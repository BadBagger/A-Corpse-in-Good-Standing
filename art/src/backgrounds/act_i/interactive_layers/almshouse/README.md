# The Almshouse - interactive_layer_sources
...
Expected files:
- `art/src/backgrounds/act_i/interactive_layers/almshouse/halfcoinprosper.psd` - interactive_layer, paintover, runtime: `game/rooms/almshouse/props/halfcoinprosper.png`, review: verify alpha, bounds, hotspot center alignment, and role readability in Godot
