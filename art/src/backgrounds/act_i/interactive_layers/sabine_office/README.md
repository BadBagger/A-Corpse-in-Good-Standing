# Sabine's Office - interactive_layer_sources
...
Expected files:
- `art/src/backgrounds/act_i/interactive_layers/sabine_office/sabinedesk.psd` - interactive_layer, paintover, runtime: `game/rooms/sabine_office/props/sabinedesk.png`, review: verify alpha, bounds, hotspot center alignment, and role readability in Godot
