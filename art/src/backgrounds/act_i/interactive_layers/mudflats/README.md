# Mudflats - interactive_layer_sources
...
Expected files:
- `art/src/backgrounds/act_i/interactive_layers/mudflats/saltmarketexit.psd` - interactive_layer, paintover, runtime: `game/rooms/mudflats/props/saltmarketexit.png`, review: verify alpha, bounds, hotspot center alignment, and role readability in Godot
