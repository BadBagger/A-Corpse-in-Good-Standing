# Harbor Registry - navigation_silhouette_sources
...
Expected files:
- `art/src/backgrounds/act_i/navigation_silhouettes/harbor_registry/tosaltmarket.psd` - navigation_silhouette, paintover, runtime: `game/rooms/harbor_registry/background/harbor_registry_bg.png`, review: verify visible exit affordance, walk-band clarity, and no new unplanned route
